...
public class LoginActivity extends AppCompatActivity {
    ...
    private void getPreferencesData() {
        ...
        if (sp.contains("pref_phone")) {
            ...
            edt_numberPhone_login.setText(phone);
        }
        if (sp.contains("pref_pass")) {
            String pass = sp.getString("pref_pass", "");
            edt_password_login.setText(pass);
        }
        if (sp.contains("pref_check")){
            Boolean b = sp.getBoolean("pref_check",false);
            cbk_remember.setChecked(b);
        }
    }
                    ...
                    AndroidNetworking.post(BaseUrl.baseUrl + BaseUrl.login)
                            ...
                            .getAsObject(User.class, new ParsedRequestListener<User>() {
                                ...
                                public void onResponse(User response) {
                                    ...
                                    if (cbk_remember.isChecked()) {
                                        Boolean checked = cbk_remember.isChecked();
    ...
    private void initUI() {
        cbk_remember = findViewById(R.id.cbk_remember);
